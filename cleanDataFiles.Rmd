...
colnames(orthoData_3$PA14_LESB58) <- paste0(colnames(orthoData_3$PA14_LESB58), "_Locus_Tag")
colnames(orthoData_3$PAO1_LESB58) <- paste0(colnames(orthoData_3$PAO1_LESB58), "_Locus_Tag")
colnames(orthoData_3$PAO1_PA14) <- paste0(colnames(orthoData_3$PAO1_PA14), "_Locus_Tag")
```


### Adding annotations
```{r}
annoData_4 <- annoData_3 %>% map(~select(., -c(Nucleotide_Sequence, Amino_Acid_Sequence)))

colnames(annoData_4$LESB58_125) <- paste0("LESB58_", colnames(annoData_4$LESB58_125))
colnames(annoData_4$PAO1_107) <- paste0("PAO1_", colnames(annoData_4$PAO1_107))
colnames(annoData_4$`UCBPP-PA14_109`) <- paste0("PA14_", colnames(annoData_4$`UCBPP-PA14_109`))
